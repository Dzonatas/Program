...
nameSpaceHead
 ...
 ; 
classHead
 : ".class" classAttr id extendsClause implClause
 ; 
classAttr
 : /* EMPTY */ 
 | classAttr "public" 
...
classDecl
 ...
 ; 
fieldDecl
 : ".field" repeatOpt fieldAttr type id atOpt initOpt 
 ; 
atOpt
 : /* EMPTY */ 
 | "at" id 
...
customHeadWithOwner
 ...
 ; 
memberRef
 : methodSpec callConv type typeSpec "::" methodName '(' sigArgs0 ')' 
...
eventDecls
 ...
 ; 
eventDecl
 : ".addon" callConv type typeSpec "::" methodName '(' sigArgs0 ')' 
 ...
 ; 
propHead
 : ".property" propAttr callConv type id '(' sigArgs0 ')' initOpt 
 ; 
propAttr
 : /* EMPTY */ 
...
extSourceSpec
 ...
 ; 
fileDecl
 : ".file" fileAttr name1 fileEntry hashHead bytes ')' fileEntry 
